  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-2xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-bold font-display mb-2">Post a sublease</h1>
          <p className="text-muted">Fill in the details and your listing goes live immediately.</p>
        </div>
